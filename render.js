...
import { predictShot } from "./state";
import { lerp, m4AxisAngle, m4Ident, m4Mul, m4MulPoint, m4Perspective, m4RotX, m4RotY, m4Scale, m4Translate, radLerp, v3Add, v3AddScale, v3Sub, vecLerp } from "./types";
import { cannonGeo, castleGeo, castleGibs, gibCastle, hints, lastLevel, loadLevel, playerGeo, skyboxGeo, worldGetCastles, worldGetGeo } from "./world";
...
export let shaderCompile = (vert, frag) => {
...
export let modelGeoDraw = (me, shaderProg) => {
...
export let renderGame = (earlyInputs, state, dt) => {
    ...
    G.uniform4f(G.getUniformLocation(blitShader, 'u_info'), C2.width, C2.height, fade, ~~(state.mode == 5 /* Win */ && state.level == lastLevel));
